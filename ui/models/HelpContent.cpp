...
QString helpPl(const QString& t) {
    ...
    if (t == QLatin1String("terrain")) {
        return QStringLiteral(u"<h3>Skąd program bierze wysokości</h3>"
    ...
    if (t == QLatin1String("sites")) {
        return QStringLiteral(u"<h3>Współrzędne</h3>"
    ...
    if (t == QLatin1String("models")) {
        return QStringLiteral(u"<h3>Dlaczego kilka modeli</h3>"
    ...
    if (t == QLatin1String("budget")) {
        return QStringLiteral(u"<h3>Kaskada bilansu</h3>"
    ...
    if (t == QLatin1String("availability")) {
        return QStringLiteral(u"<h3>Model zaniku</h3>"
    ...
    if (t == QLatin1String("solver")) {
        return QStringLiteral(u"<h3>Zadanie odwrotne</h3>"
    ...
    if (t == QLatin1String("profile")) {
        return QStringLiteral(u"<h3>Co widać</h3>"
    ...
    if (t == QLatin1String("project")) {
        return QStringLiteral(u"<h3>Pliki .tlk</h3>"
    ...
    if (t == QLatin1String("about")) {
        return QStringLiteral(u"<h3>TropoLink</h3>"
...
QString helpEn(const QString& t) {
    ...
    if (t == QLatin1String("map")) {
        return QStringLiteral(u"<h3>Navigation</h3>"
    ...
    if (t == QLatin1String("offline-maps")) {
        return QStringLiteral(u"<h3>Two kinds of map data</h3>"
    ...
    if (t == QLatin1String("terrain")) {
        return QStringLiteral(u"<h3>Where elevations come from</h3>"
    ...
    if (t == QLatin1String("sites")) {
        return QStringLiteral(u"<h3>Coordinates</h3>"
    ...
    if (t == QLatin1String("radio")) {
        return QStringLiteral(u"<h3>Parameters</h3>"
                              u"<ul>"
    ...
    if (t == QLatin1String("atmosphere")) {
        return QStringLiteral(u"<h3>Refraction</h3>"
    ...
    if (t == QLatin1String("models")) {
        return QStringLiteral(u"<h3>Why several models</h3>"
    ...
    if (t == QLatin1String("budget")) {
        return QStringLiteral(u"<h3>The waterfall</h3>"
    ...
    if (t == QLatin1String("availability")) {
        return QStringLiteral(u"<h3>Fading model</h3>"
    ...
    if (t == QLatin1String("solver")) {
        return QStringLiteral(u"<h3>The inverse problem</h3>"
    ...
    if (t == QLatin1String("profile")) {
        return QStringLiteral(u"<h3>What is shown</h3>"
    ...
    if (t == QLatin1String("report")) {
        return QStringLiteral(u"<h3>Contents</h3>"
    ...
    if (t == QLatin1String("project")) {
        return QStringLiteral(u"<h3>.tlk files</h3>"
...
QVariantList tropolinkHelpTopics(bool polish) {
    ...
    for (const auto& t : kTopics) {
        list << QVariantMap{{QStringLiteral("id"), QString::fromUtf8(t.id)},
                            {QStringLiteral("title"), QString::fromUtf8(polish ? t.titlePl : t.titleEn)}};
    }
    return list;
}
